<?php
namespace schallschlucker\simplecms\controllers\mediacontroller;
...
class MediaController extends Controller
{
     ...
     * @param string  $newName the new name for the category (only character, numbers, spaces and _ - allowed. All other cahracters will be filtered out)
     * @return View
     */
     ...
     * @throws \Exception
     * @internal param interger $thumbWidth the target max width in px
     * @internal param interger $thumbHeight the target max height in px
     */
